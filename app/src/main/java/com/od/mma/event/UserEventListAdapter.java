...
public class UserEventListAdapter extends RealmRecyclerViewAdapter<UserEvent, RecyclerView.ViewHolder> {
    private Context context;
    private EventListAdapterInterface eventListAdapterInterface;
    private OrderedRealmCollection<UserEvent> data;
    private View view;

    public UserEventListAdapter(@NonNull Context context, @Nullable OrderedRealmCollection<UserEvent> data, EventListAdapterInterface eventListAdapterInterface, boolean autoUpdate) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        final Event event = Event.getEvent(userEvent.getEvent(), MMAApplication.realm);
        if(event == null)
            return;
