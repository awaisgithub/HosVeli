...
public class EventListFragment extends Fragment implements EventListAdapterInterface {
    ...
    public static EventListFragment newInstance(String type) {
        Log.i(MMAConstants.TAG, "EventListFragment = " + type);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.i(MMAConstants.TAG, "EventListFragment onCreate= " + type);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.i(MMAConstants.TAG, "EventListFragment onCreateView= " + type);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        Log.i(MMAConstants.TAG, "EventListFragment onActivityCreated= " + type);
    ...
    private void initViews() {
        ...
        Log.i(MMAConstants.TAG, "initViews = " + type);
    ...
    public void gotoDetailActivity(String id) {
        ...
        intent.putExtra(MMAConstants.KEY_EVENT_ID, id);
        intent.putExtra(MMAConstants.KEY_EVENT_TYPE, type);
    ...
    public void performOperationOnEvent(EventOP op, String eventId) {
        ...
        switch (op) {
            ...
            case LAUNCH_ACTIVITY:
                Log.i(MMAConstants.TAG, "Item clicked LAUNCH_ACTIVITY type=" + type + " Type " + eventId);
                if (type.equalsIgnoreCase(EventFragment.LIST_TYPE_FEEDBACK)) {
                    ...
                    Intent intent = new Intent(getActivity(), EventDetailActivity.class);
                    intent.putExtra(MMAConstants.KEY_EVENT_ID, eventId);
                    intent.putExtra(MMAConstants.KEY_EVENT_TYPE, type);
                    startActivity(intent);
                }
                break;
