...
public class SponsorListAdapter extends RealmRecyclerViewAdapter<EventSponsor, RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        SponsorGridAdapter sponsorGridAdapter = new SponsorGridAdapter(context, EventSponsor.getSponsorByLevelName(MMAApplication.realm, sponsor.getSponsorlevelname()), true);
