...
import com.od.mma.BOs.UserEvent;
...
import com.od.mma.abouts.AboutUs;
import com.od.mma.event.agenda.AgendsMainActivity;
import com.od.mma.event.exhibitor.ExhibitorListFragment;
import com.od.mma.event.floorplan.FloorPlanFragment;
import com.od.mma.event.speaker.SpeakerListFragment;
import com.od.mma.event.sponsor.SponsorListFragment;
...
public class EventDetailActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String eventId = getIntent().getStringExtra(MMAConstants.KEY_EVENT_ID);
    ...
    private void initViews() {
        ...
        if (intent != null && intent.hasExtra(MMAConstants.LAUNCH_TYPE_KEY)) {
            ...
            if (launchType.equalsIgnoreCase(MMAConstants.LAUNCH_TYPE_GCM)) {
                gcmMessage = intent.getStringExtra(MMAConstants.GCM_INTENT_KEY_MESSAGE);
    ...
    private void setInfo() {
        ...
        String type = getIntent().getStringExtra(MMAConstants.KEY_EVENT_TYPE);
    ...
    public void onClick(View view) {
        ...
        switch (viewId) {
            ...
            case R.id.button_agenda:
                ...
                intent.putExtra(MMAConstants.KEY_EVENT_ID, event.getId());
    ...
    private void bookEvent() {
        Event.bookEvent(user.getId(), event.getId(), Api.urlJogetCRUD(), new StatusCallBack() {
            ...
            public void success(JSONObject response) {
                Log.i(MMAConstants.TAG, "bookEvent success=" + response);
            ...
            public void failure(String response) {
                Log.i(MMAConstants.TAG, "bookEvent failure=" + response);
            }
        });
    }
