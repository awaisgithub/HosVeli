...
final public class HRDFConstants {
    ...
    public static final String USERGCMList = "hrdfUserNotificationTokenList";
    ...
    public static final String UserEventsList = "hrdfUserEventRSVP";
    public static final String DocumentIdsList = "hrdfDocumentUploads";
    public static final String DocumentsList = "hrdfDocumentList";
    ...
    public static final String GCM_REG_TABLE = "app_fd_hrdf_user_noti_token";
    ...
    public static final String KEY_GCM_ITEM_ID = "gcmitemid";

    public static final int PLAY_SERVICES_RESOLUTION_REQUEST = 9000;
    public static String GCM_BROADCAST_INTENT_FILTER = "gcmtoken";
    public static String GCM_ID_KEY = "GcmKey";
    public static String LAUNCH_TYPE_KEY = "launchtype";
    public static String LAUNCH_TYPE_GCM = "gcm";
    public static String LAUNCH_TYPE_NORMAL_KEY = "normal";
    public static String GCM_INTENT_KEY_MESSAGE = "message";
